...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "epcli",
		Short: "Command line interface for interacting with epcd",
	}

	// Add --chain-id to persistent flags and mark it required
	rootCmd.PersistentFlags().String(client.FlagChainID, "", "Chain ID of epc node")
	...
	// Add flags and prefix all env exposed with EPC
	executor := cli.PrepareMainCmd(rootCmd, "EPC", app.DefaultCLIHome)
...
// NOTE: details on the routes added for each module are in the mdule documentation
